...
defmodule AshR2RML.Admission do
  @moduledoc """
  ...
  alias AshR2RML.{DfCM, Refusal, SemanticIR}
  alias AshR2RML.SemanticIR.{Action, Attribute, Identity, Policy, Relationship, Resource}
  ...
  defp verify_foreign_key(resource, relationship, destination) do
    ...
    |> maybe_add(not is_nil(source_attr) and source_attr.nullable != expected_nullable, fn ->
      Refusal.new(
        :REFUSED_CARDINALITY_STORAGE_MISMATCH,
        {resource.module, relationship.name},
